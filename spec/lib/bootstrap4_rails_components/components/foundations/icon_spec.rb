...
RSpec.describe Bootstrap4RailsComponents::Components::Foundations::Icon do
  let(:icon) { described_class.new(options, ActionController::Base.new.view_context) }
  let(:options) { {} }
  let(:left_icon_spacer_css_class) { Bootstrap4RailsComponents::Components::Foundations::Icon::LEFT_ICON_SPACER_CSS_CLASS }
  let(:right_icon_spacer_css_class) { Bootstrap4RailsComponents::Components::Foundations::Icon::RIGHT_ICON_SPACER_CSS_CLASS }
  ...
  it { expect(described_class).to include Bootstrap4RailsComponents::Components::Traits::Icon }
  ...
  describe '#render' do
    ...
    describe 'icons with registered traits' do
      context 'and when a registered `Bootstrap4RailsComponents::Components::Traits` trait is present in the icon :traits' do
