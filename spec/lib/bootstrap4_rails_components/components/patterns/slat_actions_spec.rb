...
RSpec.describe Bootstrap4RailsComponents::Components::Patterns::SlatActions do
  ...
  describe '#render' do
    ...
    # spec/lib/bootstrap4_rails_components/components/utilities/patches/integrated_slat_action_spec.rb
