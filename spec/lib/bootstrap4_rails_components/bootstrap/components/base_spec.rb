...
RSpec.describe Bootstrap4RailsComponents::Bootstrap::Components::Base do
  let(:bootstrap_base) { Bootstrap4RailsComponents::Bootstrap::Components::Base.new(component_options, view_context) }
