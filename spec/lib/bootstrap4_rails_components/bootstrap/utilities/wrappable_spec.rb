...
RSpec.describe Bootstrap4RailsComponents::Bootstrap::Utilities::Wrappable do
  # Badge is wrappable
  ...
  describe 'private methods' do
    ...
    describe '#default_html_wrapper_element' do
      let(:test_class) { Class.new { include Bootstrap4RailsComponents::Bootstrap::Utilities::Wrappable }.new }
