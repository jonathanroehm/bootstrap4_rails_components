...
RSpec.describe Bootstrap4RailsComponents::Bootstrap::Utilities::CollapseToggleable do
  ...
  it { expect(described_class.included_modules).to include Bootstrap4RailsComponents::Bootstrap::Utilities::Collapsible }
