...
RSpec.describe Bootstrap4Rails::Bootstrap::Utilities::CollapseToggleable do
  ...
  it { expect(described_class.included_modules).to include Bootstrap4Rails::Bootstrap::Utilities::Collapsible }
