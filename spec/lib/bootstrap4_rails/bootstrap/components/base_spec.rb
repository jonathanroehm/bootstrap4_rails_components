...
RSpec.describe Bootstrap4Rails::Bootstrap::Components::Base do
  let(:bootstrap_base) { Bootstrap4Rails::Bootstrap::Components::Base.new(component_options, view_context) }
