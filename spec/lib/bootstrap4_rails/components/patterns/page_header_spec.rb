...
RSpec.describe Bootstrap4Rails::Components::Patterns::PageHeader do
  ...
  it { expect(described_class.included_modules).to include Bootstrap4Rails::Components::Utilities::BrowserDetectable }
  it { expect(described_class.included_modules).to include Bootstrap4Rails::Components::Traits::PageHeader }
