...
RSpec.describe Bootstrap4Rails::Components::Patterns::SlatActions do
  ...
  describe '#render' do
    ...
    # spec/lib/bootstrap4_rails/components/utilities/patches/integrated_slat_action_spec.rb
