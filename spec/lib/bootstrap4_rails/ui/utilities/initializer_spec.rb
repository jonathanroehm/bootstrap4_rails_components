...
RSpec.describe Bootstrap4Rails::UI::Utilities::Initializer do
  let(:test_class_with_initializer) { Class.new { include Bootstrap4Rails::UI::Utilities::Initializer } }
  ...
  let(:component) {
                    "Bootstrap4Rails::UI::#{component_suite}".constantize.new(
                      view_context,
