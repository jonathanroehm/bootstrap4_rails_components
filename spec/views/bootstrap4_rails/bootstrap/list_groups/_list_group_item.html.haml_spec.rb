...
RSpec.describe 'bootstrap4_rails/bootstrap/list_groups/_list_group_item.html.haml', type: :view do
  ...
  describe 'a thematic list-group-item' do
    context 'when no theme is supplied' do
      ...
      it 'does not apply a theme' do
        expect(subject).not_to have_css ".list-group-item-#{Bootstrap4Rails::DEFAULT_BOOTSTRAP_THEME.to_s}"
      end
    end
