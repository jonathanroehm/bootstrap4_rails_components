...
RSpec.describe 'bootstrap4_rails_components/bootstrap/navbars/_navbar.html.haml', type: :view do
  ...
  describe 'navbar thematics' do
    ...
    context 'when supplying a custom dark theme' do
      let(:dark_themes) { Bootstrap4RailsComponents::Bootstrap::Components::Navbar.new({}, ActionController::Base.new.view_context).send(:dark_themes) }
