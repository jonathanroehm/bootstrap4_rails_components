...
require 'bootstrap4_rails/version'

Gem::Specification.new do |s|
  s.name        = 'bootstrap4_rails'
  s.version     = Bootstrap4Rails::VERSION
  s.authors     = ['Jonathan Roehm', 'Kyle Morin']
  s.email       = ['jonathan.roehm@networkforgood.com', 'kyle.morin@networkforgood.com']
  s.homepage    = 'https://github.com/network-for-good/bootstrap4_rails'
  ...
  # When running `bundle update bootstrap4_rails` from Evo.
