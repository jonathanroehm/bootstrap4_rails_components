...
module Bootstrap4RailsComponents
  module Components
    module Elements
      ...
      class Button < Bootstrap4RailsComponents::Bootstrap::Components::Button
        ...
        include Bootstrap4RailsComponents::Components::Traits::Button
        ...
        def left_icon_component
          Bootstrap4RailsComponents::Components::Foundations::Icon.new({ traits: [left_icon],
                                                     class: Bootstrap4RailsComponents::Components::Foundations::Icon::LEFT_ICON_SPACER_CSS_CLASS },
                                                   view_context).render

        end

        def right_icon_component
          Bootstrap4RailsComponents::Components::Foundations::Icon.new({ traits: [icon, :right],
                                                     class: Bootstrap4RailsComponents::Components::Foundations::Icon::RIGHT_ICON_SPACER_CSS_CLASS },
                                                   view_context).render
        end
