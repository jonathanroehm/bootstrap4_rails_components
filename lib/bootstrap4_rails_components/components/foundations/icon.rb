...
module Bootstrap4RailsComponents
  module Components
    module Foundations
      ...
      class Icon < Bootstrap4RailsComponents::Components::Base
        include Bootstrap::Utilities::Themeable
        include Bootstrap::Utilities::Tooltipable

        include Bootstrap4RailsComponents::Components::Traits::Icon
        include Bootstrap4RailsComponents::Components::Traits::Muted
        ...
        def css_classes
          [
            super,
            (Bootstrap4RailsComponents::Components::Foundations::Icon::LEFT_ICON_SPACER_CSS_CLASS if add_left_icon_css_spacer_class?),
            (Bootstrap4RailsComponents::Components::Foundations::Icon::RIGHT_ICON_SPACER_CSS_CLASS if add_right_icon_css_spacer_class?)
          ].join(' ').squish
        end
