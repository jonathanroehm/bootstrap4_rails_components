...
module Bootstrap4RailsComponents
  module Components
    module Patterns
      ...
      class SlatActions < Bootstrap4RailsComponents::Components::Base
        ...
        # require 'bootstrap4_rails_components/components/utilities/patches/integrated_slat_action'
        include Bootstrap4RailsComponents::Components::Utilities::Patches::IntegratedSlatAction
          ...
          content_tag(:div, html_options) do
            if menu
              if slat_header
                ...
                Bootstrap4RailsComponents::Components::Patterns::Dropdown.new({ }, view_context).render do
                  capture do
                    concat(Bootstrap4RailsComponents::Components::Elements::DropdownToggle.new({ **default_dropdown_toggle_options, body: ('Actions' if wide)}, view_context).render)
                    concat(Bootstrap4RailsComponents::Components::Patterns::DropdownMenu.new({ traits: [:right] }, view_context).render {
