...
module Bootstrap4Rails
  module Bootstrap
    module Components
      ...
      class CarouselItem < Bootstrap4Rails::Bootstrap::Components::Base
        ...
        def render
          super do
            capture do
              ...
              if caption || label
                concat(Bootstrap4Rails::Bootstrap::Components::CarouselCaption.new({ body: caption, label: label }, view_context).render)
              end
