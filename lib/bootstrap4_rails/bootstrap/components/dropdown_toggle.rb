...
module Bootstrap4Rails
  module Bootstrap
    module Components
      ...
      class DropdownToggle < Bootstrap4Rails::Bootstrap::Components::Base
        ...
        def theme
          options.fetch(:theme, Bootstrap4Rails::DEFAULT_BOOTSTRAP_THEME)
        end

        def render
          Bootstrap4Rails::Bootstrap::Components::Button.new({ as: as, theme: theme, **html_options, remove_component_css_classes: nav_link }, view_context).render do
