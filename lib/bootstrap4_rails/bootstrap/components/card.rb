...
module Bootstrap4Rails
  module Bootstrap
    module Components
      ...
      class Card < Bootstrap4Rails::Bootstrap::Components::Base
        ...
        def render
          content_tag(:div, html_options) do
            capture do
              if heading.present?
                concat(Bootstrap4Rails::Bootstrap::Components::CardHeader.new({ heading: heading }, view_context).render)
              end

              concat(Bootstrap4Rails::Bootstrap::Components::CardBody.new({}, view_context).render {
                capture do
              ...
              if footer.present?
                concat(Bootstrap4Rails::Bootstrap::Components::CardFooter.new({ body: footer }, view_context).render)
              end
            end
          end
        end
