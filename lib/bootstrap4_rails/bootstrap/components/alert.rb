...
module Bootstrap4Rails
  module Bootstrap
    module Components
      ...
      class Alert < Bootstrap4Rails::Bootstrap::Components::Base
        ...
        def render
          content_tag(:div, html_options) do
            capture do
              if dismissible
                concat(
                  Bootstrap4Rails::Bootstrap::Components::Button.new({ as: :button, class: 'close', theme: nil, data: { dismiss: 'alert' }, aria: { label: 'Close' } }, view_context).render do
