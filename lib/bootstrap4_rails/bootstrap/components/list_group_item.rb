...
module Bootstrap4Rails
  module Bootstrap
    module Components
      ...
      class ListGroupItem < Bootstrap4Rails::Bootstrap::Components::Base
        ...
        def render
          super do
            capture do
              ...
              if badge
                concat(Bootstrap4Rails::Bootstrap::Components::Badge.new({ pill: true, theme: (theme || Bootstrap4Rails::DEFAULT_BOOTSTRAP_THEME), body: badge }, view_context).render)
              end
            end
          end
        end
