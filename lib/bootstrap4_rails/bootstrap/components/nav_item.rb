...
module Bootstrap4Rails
  module Bootstrap
    module Components
      ...
      class NavItem < Bootstrap4Rails::Bootstrap::Components::Base
        ...
        def render
          super do
            capture do
              if include_nav_link?
                concat(Bootstrap4Rails::Bootstrap::Components::NavLink.new({ body: (button ? button : (block_given? ? yield : body)), active: active, disabled: disabled, dropdown: dropdown, tab: tab, remote: remote, href: (tab || href) }, view_context).render)
