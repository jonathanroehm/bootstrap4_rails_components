...
module Bootstrap4Rails
  module Bootstrap
    module Components
      ...
      class NavLink < Bootstrap4Rails::Bootstrap::Components::Base
        ...
        def render
          if dropdown
            Bootstrap4Rails::Bootstrap::Components::DropdownToggle.new({ body: (block_given? ? yield : body), as: :a, **html_options, theme: nil, nav_link: true }, view_context).render
          else
            super
          end
        end
