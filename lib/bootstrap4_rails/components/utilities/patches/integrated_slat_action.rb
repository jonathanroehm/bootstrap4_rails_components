    ...
    module Utilities
      module Patches
        ...
        module IntegratedSlatAction
          ...
          # (Bootstrap4Rails::Components::Elements::Button)
          def button
          ...
          def render_button
            Bootstrap4Rails::Components::Elements::Button.new({ **integrated_slat_action_button_component_options, body: (block_given? ? yield : body) }, view_context).render
          end
          ...
          def render_link
            content_tag(:a, **integrated_slat_action_html_options) do
              if icon
                Bootstrap4Rails::Components::Foundations::Icon.new({ traits: [icon], text: (block_given? ? yield : body), theme: theme }, view_context).render
              else
