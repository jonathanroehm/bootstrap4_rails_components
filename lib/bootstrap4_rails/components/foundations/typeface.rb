...
module Bootstrap4Rails
  module Components
    module Foundations
      ...
      class Typeface < Bootstrap4Rails::Components::Base
        ...
        include Bootstrap4Rails::Components::Traits::Typeface

        def render
          super do
            if icon
              Bootstrap4Rails::Components::Foundations::Icon.new({ icon: icon, text: body }, view_context).render
            else
              body
            end
          end
