...
module Bootstrap4Rails
  module Components
    module Patterns
      ...
      class SlatActions < Bootstrap4Rails::Components::Base
        ...
        # require 'bootstrap4_rails/components/utilities/patches/integrated_slat_action'
        include Bootstrap4Rails::Components::Utilities::Patches::IntegratedSlatAction
          ...
          content_tag(:div, html_options) do
            if menu
              if slat_header
                ...
                Bootstrap4Rails::Components::Patterns::Dropdown.new({ }, view_context).render do
                  capture do
                    concat(Bootstrap4Rails::Components::Elements::DropdownToggle.new({ **default_dropdown_toggle_options, body: ('Actions' if wide)}, view_context).render)
                    concat(Bootstrap4Rails::Components::Patterns::DropdownMenu.new({ traits: [:right] }, view_context).render {
