...
module Bootstrap4Rails
  module Components
    module Patterns
      ...
      class PageHeader < Bootstrap4Rails::Components::Base
        include Bootstrap4Rails::Components::Utilities::Titleable
        include Bootstrap4Rails::Components::Utilities::BrowserDetectable
        include Bootstrap4Rails::Components::Utilities::Renderable

        include Bootstrap4Rails::Components::Traits::PageHeader
              ...
              content_tag(:div, class: 'col col-xl-11 mx-auto') do
                content_tag(:div, class: 'row align-items-center') do
                  concat(content_tag(:div, class: 'col py-2') {
                    Bootstrap4Rails::Components::Patterns::Media.new({}, view_context).render do
                      capture do
                        concat(Bootstrap4Rails::Components::Elements::MediaObject.new({}, view_context).render {
                          content_tag(:div, class: 'mr-2 h2') do
                            Bootstrap4Rails::Components::Foundations::Icon.new({ traits: [resource_theme_icon], class: "text-#{resource_theme_color} mr-0" }, view_context).render
                          end
                        })
                  ...
                  if body
                    concat(content_tag(:div, class: 'col-12 col-md-auto py-2') {
                      Bootstrap4Rails::Components::Patterns::ButtonToolbar.new({ class: 'align-items-center' }, view_context).render do
