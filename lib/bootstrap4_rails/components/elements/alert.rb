...
module Bootstrap4Rails
  module Components
    module Elements
      ...
      class Alert < Bootstrap4Rails::Bootstrap::Components::Alert
        ...
        include Bootstrap4Rails::Components::Traits::Alert
        include Bootstrap4Rails::Components::Traits::Dismiss
        ...
        def render
          ...
          content_tag(:div, html_options) do
            capture do
              if dismissible
                concat(Bootstrap4Rails::Components::Elements::Button.new({ traits: [:close], dismiss: :alert }, view_context).render)
              end

              if icon
                concat(Bootstrap4Rails::Components::Patterns::Media.new({}, view_context).render {
                  capture do

                    concat(Bootstrap4Rails::Components::Elements::MediaObject.new({}, view_context).render {
                      content_tag(:div, class: 'mr-2') do
                        Bootstrap4Rails::Components::Foundations::Icon.new({ traits: [icon] }, view_context).render
                      end
                    })
                    concat(Bootstrap4Rails::Components::Elements::MediaBody.new({}, view_context).render {
                      capture do
                        if heading
                          concat(Bootstrap4Rails::Components::Foundations::Typeface.new({ heading: heading, class: 'alert-heading' }, view_context).render)
                        end
